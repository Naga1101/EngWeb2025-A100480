exports.studentsListPage = function(slist, d){
    ...
    for(let i=0; i < slist.length ; i++){
        pagHTML += `
                <tr>
                    ...
                    <td><a href="${slist[i].github}">${slist[i].github}</a></td>
                    <td>
    ...
    pagHTML += `
                ...
                <footer class="w3-container w3-blue">
                    <h5>Generated by Nuno Aguiar in ${d}</h5>
                </footer>
            </div>
        </body>
    </html>
...
exports.studentPage = function( aluno, d ){
        ...
        <div class="w3-card-4">
            ...
            <div class="w3-container">
                <ul class="w3-ul w3-card-4" style="width:50%">
                    ...
                    <li><b>Git: </b> <a href="${aluno.github}">${aluno.github}</a></li>
                </ul>
            </div>
    ...
    pagHTML +=     `</ul></div>
            <footer class="w3-container w3-teal">
                <address>Gerado por Nuno Aguiar::RPCW2022 em ${d} - [<a href="/">Voltar</a>]</address>
            </footer>
        </div>
    </body>
    </html>
